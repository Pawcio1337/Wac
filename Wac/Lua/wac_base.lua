...
if not tweak_data.weapon.factory.parts.wpn_fps_uupg_fg_radian.override then
	tweak_data.weapon.factory.parts.wpn_fps_uupg_fg_radian.override = {}
end
...
if WacMenu._data.replace_r870_fg_small == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_shot_r870_fg_small.unit = "units/payday2/weapons/wpn_fps_shot_r870_pts/wpn_fps_shot_r870_fg_railed"
end
...
if WacMenu._data.replace_supernova_b_short == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_sho_supernova_b_short.unit = "units/pd2_dlc_pxp4/weapons/wpn_fps_sho_supernova_pts/wpn_fps_sho_supernova_b_standard"
elseif WacMenu._data.replace_supernova_b_short == 3 then
	tweak_data.weapon.factory.parts.wpn_fps_sho_supernova_b_short.unit = "units/pd2_dlc_pxp4/weapons/wpn_fps_sho_supernova_pts/wpn_fps_sho_supernova_b_long"
end
if WacMenu._data.replace_supernova_b_long == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_sho_supernova_b_long.unit = "units/pd2_dlc_pxp4/weapons/wpn_fps_sho_supernova_pts/wpn_fps_sho_supernova_b_standard"
elseif WacMenu._data.replace_supernova_b_long == 3 then
	tweak_data.weapon.factory.parts.wpn_fps_sho_supernova_b_long.unit = "units/pd2_dlc_pxp4/weapons/wpn_fps_sho_supernova_pts/wpn_fps_sho_supernova_b_short"
end
if WacMenu._data.replace_supernova_m_extender == true then
	tweak_data.weapon.factory.parts.wpn_fps_sho_supernova_m_extender.unit = "units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy"
end
if WacMenu._data.replace_supernova_shell_rack == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_sho_supernova_shell_rack.unit = "units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy"
end
if WacMenu._data.replace_supernova_ck == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_sho_supernova_conversion.adds = nil
	tweak_data.weapon.factory.parts.wpn_fps_sho_supernova_conversion.override = nil
	tweak_data.weapon.factory.parts.wpn_fps_sho_supernova_conversion.unit = "units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy"
end
...
if WacMenu._data.replace_kacchainsaw_b_short == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_lmg_kacchainsaw_b_short.unit = "units/pd2_dlc_pxp4/weapons/wpn_fps_lmg_kacchainsaw_pts/wpn_fps_lmg_kacchainsaw_b_standard"
elseif WacMenu._data.replace_kacchainsaw_b_short == 3 then
	tweak_data.weapon.factory.parts.wpn_fps_lmg_kacchainsaw_b_short.unit = "units/pd2_dlc_pxp4/weapons/wpn_fps_lmg_kacchainsaw_pts/wpn_fps_lmg_kacchainsaw_b_long"
end
if WacMenu._data.replace_kacchainsaw_b_long == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_lmg_kacchainsaw_b_long.unit = "units/pd2_dlc_pxp4/weapons/wpn_fps_lmg_kacchainsaw_pts/wpn_fps_lmg_kacchainsaw_b_standard"
elseif WacMenu._data.replace_kacchainsaw_b_long == 3 then
	tweak_data.weapon.factory.parts.wpn_fps_lmg_kacchainsaw_b_long.unit = "units/pd2_dlc_pxp4/weapons/wpn_fps_lmg_kacchainsaw_pts/wpn_fps_lmg_kacchainsaw_b_short"
end
if WacMenu._data.replace_kacchainsaw_sling == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_lmg_kacchainsaw_sling.unit = "units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy"
end
if WacMenu._data.replace_kacchainsaw_mag_b == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_lmg_kacchainsaw_mag_b.unit = "units/pd2_dlc_pxp4/weapons/wpn_fps_lmg_kacchainsaw_pts/wpn_fps_lmg_kacchainsaw_mag_a"
end
if WacMenu._data.replace_kacchainsaw_ck == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_lmg_kacchainsaw_conversionkit.unit = "units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy"
	tweak_data.weapon.factory.parts.wpn_fps_lmg_kacchainsaw_conversionkit.override = nil
end
...
if WacMenu._data.replace_hcar_m_stick == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_lmg_hcar_m_stick.unit = "units/pd2_dlc_pxp3/weapons/wpn_fps_lmg_hcar_pts/wpn_fps_lmg_hcar_m_standard"
elseif WacMenu._data.replace_hcar_m_stick == 3 then
	tweak_data.weapon.factory.parts.wpn_fps_lmg_hcar_m_stick.unit = "units/pd2_dlc_pxp3/weapons/wpn_fps_lmg_hcar_pts/wpn_fps_lmg_hcar_m_drum"
end
if WacMenu._data.replace_hcar_m_drum == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_lmg_hcar_m_drum.unit = "units/pd2_dlc_pxp3/weapons/wpn_fps_lmg_hcar_pts/wpn_fps_lmg_hcar_m_standard"
elseif WacMenu._data.replace_hcar_m_drum == 3 then
	tweak_data.weapon.factory.parts.wpn_fps_lmg_hcar_m_drum.unit = "units/pd2_dlc_pxp3/weapons/wpn_fps_lmg_hcar_pts/wpn_fps_lmg_hcar_m_stick"
end
if WacMenu._data.replace_hcar_codpartsdisabled == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_lmg_hcar_body_conversionkit.unit = "units/pd2_dlc_pxp3/weapons/wpn_fps_lmg_hcar_pts/wpn_fps_lmg_hcar_body_standard"
	tweak_data.weapon.factory.parts.wpn_fps_lmg_hcar_body_conversionkit.override = nil
elseif WacMenu._data.replace_hcar_codpartsdisabled == 3 then
	tweak_data.weapon.factory.parts.wpn_fps_lmg_hcar_body_conversionkit.unit = "units/pd2_dlc_pxp3/weapons/wpn_fps_lmg_hcar_pts/wpn_fps_lmg_hcar_body_standard"
	tweak_data.weapon.factory.parts.wpn_fps_lmg_hcar_body_conversionkit.override = {
		wpn_fps_lmg_hcar_m_standard = {unit = "units/pd2_dlc_pxp3/weapons/wpn_fps_lmg_hcar_pts/wpn_fps_lmg_hcar_m_drum"}
	}
end
...
if WacMenu._data.replace_akmsu_x_stock == 2 then
	table.map_append(tweak_data.weapon.factory.wpn_fps_smg_x_akmsu.adds, {wpn_fps_smg_akmsu_body_lowerreceiver = {"wpn_upg_ak_s_folding_vanilla"}})
elseif WacMenu._data.replace_akmsu_x_stock == 3 then
	table.map_append(tweak_data.weapon.factory.wpn_fps_smg_x_akmsu.adds, {wpn_fps_smg_akmsu_body_lowerreceiver = {"wpn_upg_ak_s_skfoldable_vanilla"}})
end
...
k23bparts.m4a1sight = "wpn_fps_ass_m16_os_frontsight = {unit = \"units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy\",third_unit = \"units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy\"}, wpn_fps_ass_m16_o_handle_sight = {adds = {}, unit = \"units/payday2/weapons/wpn_fps_ass_m4_pts/wpn_fps_m4_uupg_o_flipup\",third_unit = \"units/payday2/weapons/wpn_third_ass_m4_pts/wpn_third_m4_uupg_o_flipup\",stance_mod = {wpn_fps_smg_olympic = {translation = Vector3(0, -4, 0.475)}}} }"
k23bparts.m4a1sight_emo = "wpn_fps_ass_m16_os_frontsight = {unit = \"units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy\",third_unit = \"units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy\"}, wpn_fps_ass_m16_o_handle_sight = {adds = {}, unit = \"units/payday2/weapons/wpn_fps_ass_m4_pts/wpn_fps_m4_uupg_o_flipup_emo\",third_unit = \"units/payday2/weapons/wpn_third_ass_m4_pts/wpn_third_m4_uupg_o_flipup_emo\",stance_mod = {wpn_fps_smg_olympic = {translation = Vector3(0, -4, 0.475)}}} }"
else
k23bparts.m4a1sight = "wpn_fps_ass_m16_os_frontsight = {unit = \"units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy\",third_unit = \"units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy\"}}"
k23bparts.m4a1sight_emo = "wpn_fps_ass_m16_os_frontsight = {unit = \"units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy\",third_unit = \"units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy\"}}"
end
...
elseif WacMenu._data.replace_k23railfg == 13 then
	tweak_data.weapon.factory.parts.wpn_fps_smg_olympic_fg_railed.forbids = {"wpn_fps_ass_m16_os_frontsight"}
	tweak_data.weapon.factory.parts.wpn_fps_smg_olympic_fg_railed.unit = "units/pd2_dlc_mxm/weapons/wpn_fps_upg_mxm_m4/wpn_fps_m4_uupg_fg_radian"
assert(loadstring(k23bparts.railedovr .. k23bparts.string2 .. k23bparts.m4a1sight))()
end
...
elseif WacMenu._data.replace_k23afterfg == 13 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_smg_olympic_fg_lr300.forbids = {"wpn_fps_ass_m16_os_frontsight"}
	tweak_data.weapon.factory.parts.wpn_fps_upg_smg_olympic_fg_lr300.unit = "units/pd2_dlc_mxm/weapons/wpn_fps_upg_mxm_m4/wpn_fps_m4_uupg_fg_radian"
assert(loadstring(k23bparts.lr300ovr .. k23bparts.string2 .. k23bparts.m4a1sight))()
end
...
if WacMenu._data.replace_vityaz_b_long == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_smg_vityaz_b_long.unit = "units/pd2_dlc_fawp/weapons/wpn_fps_smg_vityaz_pts/wpn_fps_smg_vityaz_b_standard"
end
if WacMenu._data.replace_vityaz_s_short == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_smg_vityaz_s_short.unit = "units/pd2_dlc_fawp/weapons/wpn_fps_smg_vityaz_pts/wpn_fps_smg_vityaz_s_standard"
end
...
if WacMenu._data.replace_t33_b_long == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_pis_type54_b_long.unit = "units/pd2_dlc_tawp/weapons/wpn_fps_pis_type54_pts/wpn_fps_pis_type54_b_standard"
end
if WacMenu._data.replace_t33_m_ext == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_pis_type54_m_ext.unit = "units/pd2_dlc_tawp/weapons/wpn_fps_pis_type54_pts/wpn_fps_pis_type54_m_standard"
end
-- Attachments
local ak_fg_ovr = {}
...
if WacMenu._data.replace_ar15_g_billet == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_m4_uupg_g_billet.unit = "units/payday2/weapons/wpn_fps_upg_m4_reusable/wpn_fps_upg_m4_g_ergo"
elseif WacMenu._data.replace_ar15_g_billet == 3 then
	tweak_data.weapon.factory.parts.wpn_fps_m4_uupg_g_billet.unit = "units/pd2_dlc_dec5/weapons/wpn_fps_upg_m4_g_hgrip/wpn_fps_upg_m4_g_hgrip"
elseif WacMenu._data.replace_ar15_g_billet == 4 then
	tweak_data.weapon.factory.parts.wpn_fps_m4_uupg_g_billet.unit = "units/pd2_dlc_dec5/weapons/wpn_fps_upg_m4_g_mgrip/wpn_fps_upg_m4_g_mgrip"
elseif WacMenu._data.replace_ar15_g_billet == 5 then
	tweak_data.weapon.factory.parts.wpn_fps_m4_uupg_g_billet.unit = "units/pd2_dlc_opera/weapons/wpn_fps_ass_tecci_pts/wpn_fps_ass_tecci_g_standard"
elseif WacMenu._data.replace_ar15_g_billet == 6 then
	tweak_data.weapon.factory.parts.wpn_fps_m4_uupg_g_billet.unit = "units/payday2/weapons/wpn_fps_upg_m4_reusable/wpn_fps_upg_m4_g_standard"
elseif WacMenu._data.replace_ar15_g_billet == 7 then
	tweak_data.weapon.factory.parts.wpn_fps_m4_uupg_g_billet.unit = "units/pd2_dlc_spa/weapons/wpn_fps_snp_tti_pts/wpn_fps_snp_tti_g_grippy"
end
if WacMenu._data.replace_ar15_g_mod3 == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_snp_victor_g_mod3.unit = "units/payday2/weapons/wpn_fps_upg_m4_reusable/wpn_fps_upg_m4_g_ergo"
elseif WacMenu._data.replace_ar15_g_mod3 == 3 then
	tweak_data.weapon.factory.parts.wpn_fps_snp_victor_g_mod3.unit = "units/pd2_dlc_dec5/weapons/wpn_fps_upg_m4_g_hgrip/wpn_fps_upg_m4_g_hgrip"
elseif WacMenu._data.replace_ar15_g_mod3 == 4 then
	tweak_data.weapon.factory.parts.wpn_fps_snp_victor_g_mod3.unit = "units/pd2_dlc_dec5/weapons/wpn_fps_upg_m4_g_mgrip/wpn_fps_upg_m4_g_mgrip"
elseif WacMenu._data.replace_ar15_g_mod3 == 5 then
	tweak_data.weapon.factory.parts.wpn_fps_snp_victor_g_mod3.unit = "units/pd2_dlc_opera/weapons/wpn_fps_ass_tecci_pts/wpn_fps_ass_tecci_g_standard"
elseif WacMenu._data.replace_ar15_g_mod3 == 6 then
	tweak_data.weapon.factory.parts.wpn_fps_snp_victor_g_mod3.unit = "units/payday2/weapons/wpn_fps_upg_m4_reusable/wpn_fps_upg_m4_g_standard"
elseif WacMenu._data.replace_ar15_g_mod3 == 7 then
	tweak_data.weapon.factory.parts.wpn_fps_snp_victor_g_mod3.unit = "units/pd2_dlc_spa/weapons/wpn_fps_snp_tti_pts/wpn_fps_snp_tti_g_grippy"
end
...
if WacMenu._data.replace_ar15_m_strike == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_m4_uupg_m_strike.unit = "units/payday2/weapons/wpn_fps_upg_m4_reusable/wpn_fps_upg_m4_m_straight"
elseif WacMenu._data.replace_ar15_m_strike == 3 then
	tweak_data.weapon.factory.parts.wpn_fps_m4_uupg_m_strike.unit = "units/payday2/weapons/wpn_fps_ass_m4_pts/wpn_fps_m4_uupg_m_std"
elseif WacMenu._data.replace_ar15_m_strike == 4 then
	tweak_data.weapon.factory.parts.wpn_fps_m4_uupg_m_strike.unit = "units/payday2/weapons/wpn_fps_upg_m4_reusable/wpn_fps_upg_m4_m_pmag"
elseif WacMenu._data.replace_ar15_m_strike == 5 then
	tweak_data.weapon.factory.parts.wpn_fps_m4_uupg_m_strike.unit = "units/pd2_dlc_gage_jobs/weapons/wpn_fps_upg_m4_m_quad/wpn_fps_upg_m4_m_quad"
elseif WacMenu._data.replace_ar15_m_strike == 6 then
	tweak_data.weapon.factory.parts.wpn_fps_m4_uupg_m_strike.unit = "units/pd2_dlc_clover/weapons/wpn_fps_ass_l85a2_pts/wpn_fps_ass_l85a2_m_emag"
elseif WacMenu._data.replace_ar15_m_strike == 7 then
	tweak_data.weapon.factory.parts.wpn_fps_m4_uupg_m_strike.unit = "units/pd2_dlc_akm4_modpack/weapons/wpn_fps_upg_m4_m_l5/wpn_fps_upg_m4_m_l5"
elseif WacMenu._data.replace_ar15_m_strike == 8 then
	tweak_data.weapon.factory.parts.wpn_fps_m4_uupg_m_strike.unit = "units/payday2/weapons/wpn_fps_ass_aug_pts/wpn_fps_aug_m_pmag"
elseif WacMenu._data.replace_ar15_m_strike == 9 then
	tweak_data.weapon.factory.parts.wpn_fps_m4_uupg_m_strike.bullet_objects = {prefix = "g_bullet_", amount = 100}
	tweak_data.weapon.factory.parts.wpn_fps_m4_uupg_m_strike.unit = "units/pd2_dlc_opera/weapons/wpn_fps_ass_tecci_pts/wpn_fps_ass_tecci_m_drum"
end
...
elseif WacMenu._data.replace_ar15_s_mod0 == 3 then
	tweak_data.weapon.factory.parts.wpn_fps_snp_victor_s_mod0.unit = "units/payday2/weapons/wpn_fps_upg_m4_reusable/wpn_fps_upg_m4_s_standard"
elseif WacMenu._data.replace_ar15_s_mod0 == 4 then
...
elseif WacMenu._data.replace_ar15corelower == 3 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_ass_m4_lower_reciever_core.unit = "units/pd2_dlc_mxm/weapons/wpn_fps_upg_mxm_m4/wpn_fps_m4_uupg_lorec_radian"
end
...
elseif WacMenu._data.replace_ar15radianlower == 3 then
	tweak_data.weapon.factory.parts.wpn_fps_m4_uupg_lower_radian.unit = "units/pd2_dlc_akm4_modpack/weapons/wpn_fps_upg_ass_m4_lower_reciever_core/wpn_fps_upg_ass_m4_lower_reciever_core"
end
...
elseif WacMenu._data.replace_ar15roundupper == 5 then
	tweak_data.weapon.factory.parts.wpn_fps_m4_upper_reciever_round.unit = "units/pd2_dlc_mxm/weapons/wpn_fps_upg_mxm_m4/wpn_fps_m4_uupg_upprec_radian"
end
...
elseif WacMenu._data.replace_ar15roundhandle == 4 then
	tweak_data.weapon.factory.parts.wpn_fps_m4_upper_reciever_round.override.wpn_fps_m4_uupg_draghandle = {unit = "units/pd2_dlc_mxm/weapons/wpn_fps_upg_mxm_m4/wpn_fps_m4_uupg_draghandle_radian"}
end
...
elseif WacMenu._data.replace_ar15vltorupper == 5 then
	tweak_data.weapon.factory.parts.wpn_fps_m4_upper_reciever_edge.unit = "units/pd2_dlc_mxm/weapons/wpn_fps_upg_mxm_m4/wpn_fps_m4_uupg_upprec_radian"
end
...
elseif WacMenu._data.replace_ar15vltorhandle == 4 then
	tweak_data.weapon.factory.parts.wpn_fps_m4_upper_reciever_edge.override.wpn_fps_m4_uupg_draghandle = {unit = "units/pd2_dlc_mxm/weapons/wpn_fps_upg_mxm_m4/wpn_fps_m4_uupg_draghandle_radian"}
end
...
elseif WacMenu._data.replace_ar15baliosupper == 5 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_ass_m4_upper_reciever_ballos.unit = "units/pd2_dlc_mxm/weapons/wpn_fps_upg_mxm_m4/wpn_fps_m4_uupg_upprec_radian"
end
...
elseif WacMenu._data.replace_ar15balioshandle == 4 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_ass_m4_upper_reciever_ballos.override.wpn_fps_m4_uupg_draghandle = {unit = "units/pd2_dlc_mxm/weapons/wpn_fps_upg_mxm_m4/wpn_fps_m4_uupg_draghandle_radian"}
end
...
elseif WacMenu._data.replace_ar15coreupper == 5 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_ass_m4_upper_reciever_core.unit = "units/pd2_dlc_mxm/weapons/wpn_fps_upg_mxm_m4/wpn_fps_m4_uupg_upprec_radian"
end
...
elseif WacMenu._data.replace_ar15corehandle == 4 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_ass_m4_upper_reciever_core.override.wpn_fps_m4_uupg_draghandle = {unit = "units/pd2_dlc_mxm/weapons/wpn_fps_upg_mxm_m4/wpn_fps_m4_uupg_draghandle_radian"}
end
...
elseif WacMenu._data.replace_ar15radianupper == 5 then
	tweak_data.weapon.factory.parts.wpn_fps_m4_uupg_upper_radian.unit = "units/pd2_dlc_akm4_modpack/weapons/wpn_fps_upg_ass_m4_upper_reciever_core/wpn_fps_upg_ass_m4_upper_reciever_core"
end
...
elseif WacMenu._data.replace_ar15radianbolt == 5 then
	tweak_data.weapon.factory.parts.wpn_fps_m4_uupg_upper_radian.override.wpn_fps_amcar_bolt_standard = {unit = "units/pd2_dlc_akm4_modpack/weapons/wpn_fps_upg_ass_m4_bolt_core/wpn_fps_upg_ass_m4_bolt_core"}
end
...
elseif WacMenu._data.replace_ar15radianhandle == 4 then
	tweak_data.weapon.factory.parts.wpn_fps_m4_uupg_upper_radian.override.wpn_fps_m4_uupg_draghandle = {unit = "units/pd2_dlc_akm4_modpack/weapons/wpn_fps_m4_uupg_draghandle_core/wpn_fps_m4_uupg_draghandle_core"}
end
local barrelext = {}
...
elseif WacMenu._data.replace_compactlaser == 4 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_fl_ass_laser.adds = nil
	tweak_data.weapon.factory.parts.wpn_fps_upg_fl_ass_laser.unit = "units/payday2_cash/safes/sputnik/weapons/wpn_fps_ass_74_rodina_pts/wpn_upg_ak_fl_legend"
end
...
elseif WacMenu._data.replace_peq15 == 4 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_fl_ass_peq15.adds = nil
	tweak_data.weapon.factory.parts.wpn_fps_upg_fl_ass_peq15.unit = "units/payday2_cash/safes/sputnik/weapons/wpn_fps_ass_74_rodina_pts/wpn_upg_ak_fl_legend"
end
...
elseif WacMenu._data.replace_peq15 == 5 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_fl_ass_utg.adds = nil
	tweak_data.weapon.factory.parts.wpn_fps_upg_fl_ass_utg.unit = "units/payday2_cash/safes/sputnik/weapons/wpn_fps_ass_74_rodina_pts/wpn_upg_ak_fl_legend"
end
...
elseif WacMenu._data.replace_dbal_laser == 5 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_fl_dbal_laser.adds = nil
	tweak_data.weapon.factory.parts.wpn_fps_upg_fl_dbal_laser.unit = "units/payday2_cash/safes/sputnik/weapons/wpn_fps_ass_74_rodina_pts/wpn_upg_ak_fl_legend"
end
...
elseif WacMenu._data.replace_x400v == 5 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_fl_pis_x400v.adds = {}
	tweak_data.weapon.factory.parts.wpn_fps_upg_fl_pis_x400v.unit = "units/pd2_dlc_lawp/weapons/wpn_fps_upg_fl_pis_perst/wpn_fps_upg_fl_pis_perst"
elseif WacMenu._data.replace_x400v == 6 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_fl_pis_x400v.adds = {}
	tweak_data.weapon.factory.parts.wpn_fps_upg_fl_pis_x400v.unit = "units/payday2_cash/safes/sputnik/weapons/wpn_fps_ass_74_rodina_pts/wpn_upg_ak_fl_legend"
end
...
elseif WacMenu._data.replace_cmr201 == 4 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_fl_pis_crimson.unit = "units/pd2_dlc_lawp/weapons/wpn_fps_upg_fl_pis_perst/wpn_fps_upg_fl_pis_perst"
elseif WacMenu._data.replace_cmr201 == 5 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_fl_pis_crimson.unit = "units/payday2_cash/safes/sputnik/weapons/wpn_fps_ass_74_rodina_pts/wpn_upg_ak_fl_legend"
end
...
if WacMenu._data.replace_pis_perst == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_fl_pis_perst.unit = "units/payday2/weapons/wpn_fps_upg_fl_pis_laser/wpn_fps_upg_fl_pis_laser"
elseif WacMenu._data.replace_pis_perst == 3 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_fl_pis_perst.unit = "units/pd2_crimefest_2014/oct22/weapons/wpn_fps_upg_fl_pis_crimson/wpn_fps_upg_fl_pis_crimson"
elseif WacMenu._data.replace_pis_perst == 4 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_fl_pis_perst.unit = "units/payday2/weapons/wpn_fps_upg_fl_pis_tlr1/wpn_fps_upg_fl_pis_tlr1"
elseif WacMenu._data.replace_pis_perst == 5 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_fl_pis_perst.unit = "units/payday2_cash/safes/sputnik/weapons/wpn_fps_ass_74_rodina_pts/wpn_upg_ak_fl_legend"
end
...
if WacMenu._data.replace_45t1micro_model == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_45rds_v2.unit = "units/pd2_dlc_mxm/weapons/wpn_fps_upg_o_piggyback/wpn_fps_upg_o_piggyback"
end
if WacMenu._data.replace_dh_d45_model == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_45steel.unit = "units/pd2_dlc_mxm/weapons/wpn_fps_upg_o_piggyback/wpn_fps_upg_o_piggyback"
end
if WacMenu._data.replace_xpsg33_model == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_xpsg33_magnifier.unit = "units/pd2_dlc_mxm/weapons/wpn_fps_upg_o_piggyback/wpn_fps_upg_o_piggyback"
end
if WacMenu._data.replace_sig_magnifier_model == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_sig.unit = "units/pd2_dlc_mxm/weapons/wpn_fps_upg_o_piggyback/wpn_fps_upg_o_piggyback"
end
...
if WacMenu._data.replace_specterbackup_zoom == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_specter_piggyback.stats.gadget_zoom = 2
elseif WacMenu._data.replace_specterbackup_zoom == 3 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_specter_piggyback.stats.gadget_zoom = 3
elseif WacMenu._data.replace_specterbackup_zoom == 4 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_specter_piggyback.stats.gadget_zoom = 4
end
...
if WacMenu._data.replace_csbackup_zoom == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_cs_piggyback.stats.gadget_zoom = 2
elseif WacMenu._data.replace_csbackup_zoom == 3 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_cs_piggyback.stats.gadget_zoom = 3
elseif WacMenu._data.replace_csbackup_zoom == 4 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_cs_piggyback.stats.gadget_zoom = 4
end
...
if WacMenu._data.replace_dh_d45_zoom == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_45steel.stats.gadget_zoom = 2
elseif WacMenu._data.replace_dh_d45_zoom == 3 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_45steel.stats.gadget_zoom = 3
elseif WacMenu._data.replace_dh_d45_zoom == 4 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_45steel.stats.gadget_zoom = 4
end
...
if WacMenu._data.replace_hamr_zoom == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_hamr.stats.zoom = 1
elseif WacMenu._data.replace_hamr_zoom == 3 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_hamr.stats.zoom = 2
elseif WacMenu._data.replace_hamr_zoom == 4 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_hamr.stats.zoom = 3
elseif WacMenu._data.replace_hamr_zoom == 5 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_hamr.stats.zoom = 4
elseif WacMenu._data.replace_hamr_zoom == 6 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_hamr.stats.zoom = 5
elseif WacMenu._data.replace_hamr_zoom == 7 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_hamr.stats.zoom = 6
end
if WacMenu._data.replace_hamrbackup_zoom == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_hamr_reddot.stats.gadget_zoom = 2
elseif WacMenu._data.replace_hamrbackup_zoom == 3 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_hamr_reddot.stats.gadget_zoom = 3
elseif WacMenu._data.replace_hamrbackup_zoom == 4 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_hamr_reddot.stats.gadget_zoom = 4
end
if WacMenu._data.replace_atibal_zoom == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_atibal.stats.zoom = 1
elseif WacMenu._data.replace_atibal_zoom == 3 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_atibal.stats.zoom = 2
elseif WacMenu._data.replace_atibal_zoom == 4 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_atibal.stats.zoom = 3
elseif WacMenu._data.replace_atibal_zoom == 5 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_atibal.stats.zoom = 4
elseif WacMenu._data.replace_atibal_zoom == 6 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_atibal.stats.zoom = 5
end
if WacMenu._data.replace_atibalbackup_zoom == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_atibal_reddot.stats.gadget_zoom = 2
elseif WacMenu._data.replace_atibalbackup_zoom == 3 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_atibal_reddot.stats.gadget_zoom = 3
elseif WacMenu._data.replace_atibalbackup_zoom == 4 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_atibal_reddot.stats.gadget_zoom = 4
end
if WacMenu._data.replace_health_zoom == 2 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_health.stats.zoom = 1
elseif WacMenu._data.replace_health_zoom == 3 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_health.stats.zoom = 3
elseif WacMenu._data.replace_health_zoom == 4 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_health.stats.zoom = 4
elseif WacMenu._data.replace_health_zoom == 5 then
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_health.stats.zoom = 5
...
elseif WacMenu._data.replace_mp7vertgrip == 3 then
	tweak_data.weapon.factory.parts.wpn_fps_smg_mp7_body_standard.adds = {"wpn_fps_smg_polymer_fg_standard"}
elseif WacMenu._data.replace_mp7vertgrip == 4 then
	tweak_data.weapon.factory.parts.wpn_fps_smg_mp7_body_standard.adds = {"wpn_fps_upg_vg_ass_smg_afg"}
...
elseif WacMenu._data.replace_mp7vertgrip == 7 then
	tweak_data.weapon.factory.parts.wpn_fps_smg_mp7_body_standard.adds = {"wpn_fps_snp_tti_vg_standard"}
elseif WacMenu._data.replace_mp7vertgrip == 8 then
...
-- OVK moment fixes
	tweak_data.weapon.factory.parts.wpn_fps_uupg_fg_radian.forbids = {"wpn_fps_m4_uupg_b_sd"}
	...
	if tweak_data.weapon.factory.parts.wpn_fps_m4_uupg_upper_radian.override.wpn_fps_m4_uupg_draghandle.third_unit then
		tweak_data.weapon.factory.parts.wpn_fps_m4_uupg_upper_radian.override.wpn_fps_m4_uupg_draghandle.third_unit = "units/payday2/weapons/wpn_third_ass_m4_pts/wpn_third_m4_uupg_draghandle"
	end
end
-- Parts IDs
local unit_list = {}
...
unit_list.ak_g_edg = "wpn_fps_upg_ak_g_edg"
unit_list.ak_g_gradus = "wpn_fps_upg_ak_g_gradus"
unit_list.ak_g_rk9 = "wpn_fps_upg_ak_g_rk9"
...
unit_list.ar15surgeon = "wpn_fps_upg_g_m4_surgeon"
unit_list.sko12_grip = "wpn_fps_sho_sko12_body_grip"
unit_list.victor_g_mod3 = "wpn_fps_snp_victor_g_mod3"
unit_list.ar15billet = "wpn_fps_m4_uupg_g_billet"
...
parts_list.ak_s_zenitco = " = {unit = \"units/pd2_dlc_mxm/weapons/wpn_upg_ak_mod_pts/wpn_fps_upg_ak_s_zenitco\""
...
if WacMenu._data.replace_ak74upperrec_zenit == 2 then
assert(loadstring(ovr_ids.ak74 .. unit_list.ak_upper_zenit .. parts_list.akmupper))()
elseif WacMenu._data.replace_ak74upperrec_zenit == 3 then
assert(loadstring(ovr_ids.ak74 .. unit_list.ak_upper_zenit .. parts_list.ak74upper))()
end
...
elseif WacMenu._data.replace_ak74stock1 == 10 then
assert(loadstring(ovr_ids.ak74 .. unit_list.akfold .. parts_list.ak_s_zenitco .. "}"))()
end
...
elseif WacMenu._data.replace_ak74stock2 == 13 then
assert(loadstring(ovr_ids.ak74 .. unit_list.m4mk46 .. parts_list.ak_s_zenitco .. parts_list.ak_grip_noadp))()
end
...
elseif WacMenu._data.replace_ak74stock3 == 12 then
assert(loadstring(ovr_ids.ak74 .. unit_list.akwood .. parts_list.ak_s_zenitco .. "}"))()
end
...
elseif WacMenu._data.replace_ak74stock4 == 13 then
assert(loadstring(ovr_ids.ak74 .. unit_list.m4crane .. parts_list.ak_s_zenitco .. parts_list.ak_grip_noadp))()
end
if WacMenu._data.replace_ak74stock5 == 2 then
assert(loadstring(ovr_ids.ak74 .. unit_list.ak_s_zenitco .. parts_list.akskfoldable .. "}"))()
elseif WacMenu._data.replace_ak74stock5 == 3 then
assert(loadstring(ovr_ids.ak74 .. unit_list.ak_s_zenitco .. parts_list.akfolding .. "}"))()
elseif WacMenu._data.replace_ak74stock5 == 4 then
assert(loadstring(ovr_ids.ak74 .. unit_list.ak_s_zenitco .. parts_list.pslst))()
elseif WacMenu._data.replace_ak74stock5 == 5 then
assert(loadstring(ovr_ids.ak74 .. unit_list.ak_s_zenitco .. parts_list.akwoodst .. "}"))()
elseif WacMenu._data.replace_ak74stock5 == 6 then
assert(loadstring(ovr_ids.ak74 .. unit_list.ak_s_zenitco .. parts_list.ar15stndst .. parts_list.ak_grip_adp))()
elseif WacMenu._data.replace_ak74stock5 == 7 then
assert(loadstring(ovr_ids.ak74 .. unit_list.ak_s_zenitco .. parts_list.ar15pts .. parts_list.ak_grip_adp))()
elseif WacMenu._data.replace_ak74stock5 == 8 then
assert(loadstring(ovr_ids.ak74 .. unit_list.ak_s_zenitco .. parts_list.ar15vltor .. parts_list.ak_grip_adp))()
elseif WacMenu._data.replace_ak74stock5 == 9 then
assert(loadstring(ovr_ids.ak74 .. unit_list.ak_s_zenitco .. parts_list.galilstndst .. "}"))()
elseif WacMenu._data.replace_ak74stock5 == 10 then
assert(loadstring(ovr_ids.ak74 .. unit_list.ak_s_zenitco .. parts_list.dummy_unit_open .. "}"))()
end
-- AKM
...
if WacMenu._data.replace_akmupperrec_zenit == 2 then
assert(loadstring(ovr_ids.akm .. unit_list.ak_upper_zenit .. parts_list.akmupper))()
elseif WacMenu._data.replace_akmupperrec_zenit == 3 then
assert(loadstring(ovr_ids.akm .. unit_list.ak_upper_zenit .. parts_list.ak74upper))()
end
...
elseif WacMenu._data.replace_akmstock1 == 10 then
assert(loadstring(ovr_ids.akm .. unit_list.akskfoldable .. parts_list.ak_s_zenitco .. "}"))()
end
...
elseif WacMenu._data.replace_akmstock2 == 13 then
assert(loadstring(ovr_ids.akm .. unit_list.m4mk46 .. parts_list.ak_s_zenitco .. parts_list.ak_grip_noadp))()
end
...
elseif WacMenu._data.replace_akmstock3 == 12 then
assert(loadstring(ovr_ids.akm .. unit_list.m4crane .. parts_list.dummy_unit_open .. parts_list.ak_grip_noadp))()
elseif WacMenu._data.replace_akmstock3 == 13 then
assert(loadstring(ovr_ids.akm .. unit_list.m4crane .. parts_list.ak_s_zenitco .. parts_list.ak_grip_noadp))()
end
...
assert(loadstring(ovr_ids.akm .. unit_list.akwood .. parts_list.ak_s_zenitco .. "}"))()
end
if WacMenu._data.replace_akmstock5 == 2 then
assert(loadstring(ovr_ids.akm .. unit_list.ak_s_zenitco .. parts_list.akfolding .. "}"))()
elseif WacMenu._data.replace_akmstock5 == 3 then
assert(loadstring(ovr_ids.akm .. unit_list.ak_s_zenitco .. parts_list.akskfoldable .. "}"))()
elseif WacMenu._data.replace_akmstock5 == 4 then
assert(loadstring(ovr_ids.akm .. unit_list.ak_s_zenitco .. parts_list.pslst))()
elseif WacMenu._data.replace_akmstock5 == 5 then
assert(loadstring(ovr_ids.akm .. unit_list.ak_s_zenitco .. parts_list.akwoodst .. "}"))()
elseif WacMenu._data.replace_akmstock5 == 6 then
assert(loadstring(ovr_ids.akm .. unit_list.ak_s_zenitco .. parts_list.ar15stndst .. parts_list.ak_grip_adp))()
elseif WacMenu._data.replace_akmstock5 == 7 then
assert(loadstring(ovr_ids.akm .. unit_list.ak_s_zenitco .. parts_list.ar15pts .. parts_list.ak_grip_adp))()
elseif WacMenu._data.replace_akmstock5 == 8 then
assert(loadstring(ovr_ids.akm .. unit_list.ak_s_zenitco .. parts_list.ar15vltor .. parts_list.ak_grip_adp))()
elseif WacMenu._data.replace_akmstock5 == 9 then
assert(loadstring(ovr_ids.akm .. unit_list.ak_s_zenitco .. parts_list.galilstndst .. "}"))()
elseif WacMenu._data.replace_akmstock5 == 10 then
assert(loadstring(ovr_ids.akm .. unit_list.ak_s_zenitco .. parts_list.dummy_unit_open .. "}"))()
end
-- AKM Gold
...
assert(loadstring(ovr_ids.hk416c .. unit_list.ar15surgeon .. parts_list.hk416cgrip))()
assert(loadstring(ovr_ids.hk416c .. unit_list.sko12_grip .. parts_list.hk416cgrip))()
assert(loadstring(ovr_ids.hk416c .. unit_list.victor_g_mod3 .. parts_list.hk416cgrip))()
assert(loadstring(ovr_ids.hk416c .. unit_list.ar15billet .. parts_list.hk416cgrip))()
end
if WacMenu._data.replace_hk416stock1 == 2 then
assert(loadstring(ovr_ids.hk416c .. unit_list.m4fold .. parts_list.hk416cst))()
elseif WacMenu._data.replace_hk416stock1 == 3 then
assert(loadstring(ovr_ids.hk416c .. unit_list.m4fold .. parts_list.ar15pts .. parts_list.ar15addadp))()
elseif WacMenu._data.replace_hk416stock1 == 5 then
assert(loadstring(ovr_ids.hk416c .. unit_list.m4fold .. parts_list.ar15crane .. parts_list.ar15addadp))()
elseif WacMenu._data.replace_hk416stock1 == 6 then
assert(loadstring(ovr_ids.hk416c .. unit_list.m4fold .. parts_list.m16a4solid))()
elseif WacMenu._data.replace_hk416stock1 == 7 then
assert(loadstring(ovr_ids.hk416c .. unit_list.m4fold .. parts_list.ar15stndst .. parts_list.ar15addadp))()
elseif WacMenu._data.replace_hk416stock1 == 8 then
...
assert(loadstring(ovr_ids.m4a1 .. unit_list.ar15surgeon .. parts_list.ar15gripstnd))()
assert(loadstring(ovr_ids.m4a1 .. unit_list.sko12_grip .. parts_list.ar15gripstnd))()
assert(loadstring(ovr_ids.m4a1 .. unit_list.victor_g_mod3 .. parts_list.ar15gripstnd))()
assert(loadstring(ovr_ids.m4a1 .. unit_list.ar15billet .. parts_list.ar15gripstnd))()
end
...
assert(loadstring(ovr_ids.m16 .. unit_list.ar15surgeon .. parts_list.ar15gripstnd))()
assert(loadstring(ovr_ids.m16 .. unit_list.sko12_grip .. parts_list.ar15gripstnd))()
assert(loadstring(ovr_ids.m16 .. unit_list.victor_g_mod3 .. parts_list.ar15gripstnd))()
assert(loadstring(ovr_ids.m16 .. unit_list.ar15billet .. parts_list.ar15gripstnd))()
end
...
elseif WacMenu._data.replace_s12kstock1 == 8 then
assert(loadstring(ovr_ids.s12k .. unit_list.akskfoldable .. parts_list.ak_s_zenitco .. "}"))()
end
...
elseif WacMenu._data.replace_s12kstock2 == 8 then
assert(loadstring(ovr_ids.s12k .. unit_list.m4mk46 .. parts_list.ak_s_zenitco .. parts_list.ak_grip_noadp))()
end
...
elseif WacMenu._data.replace_s12kstock3 == 7 then
assert(loadstring(ovr_ids.s12k .. unit_list.akwood .. parts_list.ak_s_zenitco .. "}"))()
end
-- Short 870
...
if WacMenu._data.replace_akmsuupperrec_zenit == 2 then
assert(loadstring(ovr_ids.akmsu .. unit_list.ak_upper_zenit .. parts_list.akmupper))()
elseif WacMenu._data.replace_akmsuupperrec_zenit == 3 then
assert(loadstring(ovr_ids.akmsu .. unit_list.ak_upper_zenit .. parts_list.ak74upper))()
end
...
elseif WacMenu._data.replace_akmsustock1 == 9 then
assert(loadstring(ovr_ids.akmsu .. unit_list.akskfoldable .. parts_list.ak_s_zenitco .. "}"))()
end
...
elseif WacMenu._data.replace_akmsustock2 == 12 then
assert(loadstring(ovr_ids.akmsu .. unit_list.m4mk46 .. parts_list.ak_s_zenitco .. parts_list.ak_grip_noadp))()
end
...
elseif WacMenu._data.replace_akmsustock3 == 11 then
assert(loadstring(ovr_ids.akmsu .. unit_list.akwood .. parts_list.ak_s_zenitco .. "}"))()
end
if WacMenu._data.replace_akmsustock4 == 2 then
assert(loadstring(ovr_ids.akmsu .. unit_list.ak_s_zenitco .. parts_list.akskfoldable .. "}"))()
elseif WacMenu._data.replace_akmsustock4 == 3 then
assert(loadstring(ovr_ids.akmsu .. unit_list.ak_s_zenitco .. parts_list.akfolding .. "}"))()
elseif WacMenu._data.replace_akmsustock4 == 4 then
assert(loadstring(ovr_ids.akmsu .. unit_list.ak_s_zenitco .. parts_list.pslst))()
elseif WacMenu._data.replace_akmsustock4 == 5 then
assert(loadstring(ovr_ids.akmsu .. unit_list.ak_s_zenitco .. parts_list.akwoodst .. "}"))()
elseif WacMenu._data.replace_akmsustock4 == 6 then
assert(loadstring(ovr_ids.akmsu .. unit_list.ak_s_zenitco .. parts_list.ar15stndst .. parts_list.ak_grip_adp))()
elseif WacMenu._data.replace_akmsustock4 == 7 then
assert(loadstring(ovr_ids.akmsu .. unit_list.ak_s_zenitco .. parts_list.ar15pts .. parts_list.ak_grip_adp))()
elseif WacMenu._data.replace_akmsustock4 == 8 then
assert(loadstring(ovr_ids.akmsu .. unit_list.ak_s_zenitco .. parts_list.ar15vltor .. parts_list.ak_grip_adp))()
elseif WacMenu._data.replace_akmsustock4 == 9 then
assert(loadstring(ovr_ids.akmsu .. unit_list.ak_s_zenitco .. parts_list.dummy_unit_open .. "}"))()
end
-- AKMSU Akimbo
...
p90parts.stringputnik = parts_list.dummy_unit_open .. ", a_obj = \"a_os\", parent = \"barrel\"" .. p90parts.override .. "}"
...
assert(loadstring(ovr_ids.p90 .. supp.putnik .. p90parts.stringputnik))()
...
assert(loadstring(ovr_ids.p90_x .. supp.putnik .. p90parts.stringputnik))()
end
-- SR-2
...
assert(loadstring(ovr_ids.ttitr1 .. unit_list.ar15surgeon .. parts_list.ttitr1grip))()
assert(loadstring(ovr_ids.ttitr1 .. unit_list.sko12_grip .. parts_list.ttitr1grip))()
...
assert(loadstring(ovr_ids.ak12 .. unit_list.ak_g_edg .. parts_list.ak12grip))()
assert(loadstring(ovr_ids.ak12 .. unit_list.ak_g_gradus .. parts_list.ak12grip))()
assert(loadstring(ovr_ids.ak12 .. unit_list.ak_g_rk9 .. parts_list.ak12grip))()
end
...
assert(loadstring(ovr_ids.pp19 .. unit_list.ak_g_edg .. parts_list.pp19grip))()
assert(loadstring(ovr_ids.pp19 .. unit_list.ak_g_gradus .. parts_list.pp19grip))()
assert(loadstring(ovr_ids.pp19 .. unit_list.ak_g_rk9 .. parts_list.pp19grip))()
...
assert(loadstring(ovr_ids.pp19_x .. unit_list.ak_g_edg .. parts_list.pp19grip))()
assert(loadstring(ovr_ids.pp19_x .. unit_list.ak_g_gradus .. parts_list.pp19grip))()
assert(loadstring(ovr_ids.pp19_x .. unit_list.ak_g_rk9 .. parts_list.pp19grip))()
end
-- MP40
...
if WacMenu._data.replace_vityaz_grip == true then
assert(loadstring(ovr_ids.vityaz .. unit_list.akhgrip .. parts_list.vityazgrip))()
assert(loadstring(ovr_ids.vityaz .. unit_list.akwgrip .. parts_list.vityazgrip))()
assert(loadstring(ovr_ids.vityaz .. unit_list.akpgrip .. parts_list.vityazgrip))()
assert(loadstring(ovr_ids.vityaz .. unit_list.akrk3g .. parts_list.vityazgrip))()
assert(loadstring(ovr_ids.vityaz .. unit_list.ak_g_edg .. parts_list.vityazgrip))()
assert(loadstring(ovr_ids.vityaz .. unit_list.ak_g_gradus .. parts_list.vityazgrip))()
assert(loadstring(ovr_ids.vityaz .. unit_list.ak_g_rk9 .. parts_list.vityazgrip))()
assert(loadstring(ovr_ids.vityaz_x .. unit_list.akhgrip .. parts_list.vityazgrip))()
assert(loadstring(ovr_ids.vityaz_x .. unit_list.akwgrip .. parts_list.vityazgrip))()
assert(loadstring(ovr_ids.vityaz_x .. unit_list.akpgrip .. parts_list.vityazgrip))()
assert(loadstring(ovr_ids.vityaz_x .. unit_list.akrk3g .. parts_list.vityazgrip))()
assert(loadstring(ovr_ids.vityaz_x .. unit_list.ak_g_edg .. parts_list.vityazgrip))()
assert(loadstring(ovr_ids.vityaz_x .. unit_list.ak_g_gradus .. parts_list.vityazgrip))()
assert(loadstring(ovr_ids.vityaz_x .. unit_list.ak_g_rk9 .. parts_list.vityazgrip))()
end
-- M60
