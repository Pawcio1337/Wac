...
Hooks:Add("MenuManagerInitialize", "MenuManagerInitialize_WacMenu", function(menu_manager)
	...
	MenuCallbackHandler.callback_toggle_replace_scout_es_keepboltmodel = function(self, item)
		WacMenu._data.replace_scout_es_keepboltmodel = (item:value() == "on" and true or false)
		WacMenu:Save()
	end
	...
	MenuCallbackHandler.callback_toggle_replace_replace_supp_putnik = function(self, item)
